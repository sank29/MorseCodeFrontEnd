...
let encodingFunction = async (value) => {
  let url = `http://morsecodebackend-env.eba-jexgatmg.us-east-1.elasticbeanstalk.com/encode`;
...
let decodingFunction = async (value) => {
  let url = `http://morsecodebackend-env.eba-jexgatmg.us-east-1.elasticbeanstalk.com/decode`;
